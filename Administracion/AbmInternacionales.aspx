<%@ Page Title="" Language="C#" MasterPageFile="~/MPAdministracion.Master" AutoEventWireup="true" CodeBehind="AbmInternacionales.aspx.cs" Inherits="Administracion.AbmInternacionales" %>
    ...
    <table style="width:100%;">
        <tr>
            ...
            <td align="center" colspan="3" width="36%">
                <asp:Label ID="lblTitulo" runat="server" Text="Viajes Internacionales"></asp:Label>
            </td>
...
&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            <td colspan="2">
                <asp:Label ID="lblServicios" runat="server" Text="Servicio a bordo"></asp:Label>
            </td>
        ...
        <tr>
            <td colspan="7" style="width: 56%">
                <textarea id="TextArea1" cols="20" name="S1" rows="2" style="width: 70%" 
                    runat="server" placeholder="Descripción"></textarea></td>
        </tr>
        <tr>
            <td colspan="7" style="width: 56%">
                &nbsp;</td>
